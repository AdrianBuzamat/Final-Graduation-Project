	...
	CommandLineRunner atStartup(ReservationRepository reservationRepository){
		return args -> {
			reservationRepository.saveAll(List.of(
					new Reservation(new Person("Adrian", "Buzamat", "0723212212"), new City("Oradea"), new Institution("Hiperdia", MEDICAL_CLINIQUE))
					,new Reservation(new Person("Dragos", "Axinte", "0723232124"), new City("Cluj"), new Institution("Carol", RESTAURANT))
					,new Reservation(new Person("Ciprian", "Baciu", "0723255524"), new City("Cluj"), new Institution("Unirea", HOTEL))
